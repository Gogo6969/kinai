      ...
      (globalThis as any).__mockPeers ?? [
        {
          ...
          // The ~100-year sentinel the host writes for "never expires".
          expires_at: new Date(Date.now() + 36_500 * 86_400_000).toISOString(),
          join_url: 'kinai://join?host=mock&code=aaa111&token=mock',
          scope: 'family',
        },
        {
          invite_id: 'bbb222',
          ...
          join_url: 'kinai://join?host=mock&code=bbb222&token=mock',
          scope: 'family',
        },
        {
          invite_id: 'ccc333',
          ...
          join_url: 'kinai://join?host=mock&code=ccc333&token=mock',
          scope: 'family',
          first_seen: null,
          last_seen: null,
        },
